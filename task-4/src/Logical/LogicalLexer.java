...
public class LogicalLexer {
    ...
    private final Pattern availablePatterns = Pattern.compile("([a-zA-Z]+)|(or)|(xor)|(and)|(not)|(in)|(\\()|(\\))|([a-z])|([ \\n\\t\\r]+)");
    ...
    private final List<Pair<Rule, Pattern>> lexerRules = new ArrayList<>(Arrays.asList(
        new Pair<>(Rule.OR, Pattern.compile("or")),
        new Pair<>(Rule.XOR, Pattern.compile("xor")),
        new Pair<>(Rule.AND, Pattern.compile("and")),
        new Pair<>(Rule.NOT, Pattern.compile("not")),
        new Pair<>(Rule.IN, Pattern.compile("in")),
        new Pair<>(Rule.L_PARAN, Pattern.compile("\\(")),
        new Pair<>(Rule.R_PARAN, Pattern.compile("\\)")),
        new Pair<>(Rule.VAR, Pattern.compile("[a-z]")),
    ...
    public LogicalLexer(String text) {
